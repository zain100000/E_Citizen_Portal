          ...
          <View className="p-5">
            ...
            <View className="border-2 border-gray-500 rounded-md text-[18px] text-gray-500 pl-3 mt-3">
              <Picker
                ...
                />
                <Picker.Item
                  label="Traditional kidnapping"
                  value="Traditional kidnapping"
                />
                <Picker.Item
                  label="Kidnapping for Ransom"
                  value="Kidnapping for Ransom"
                />
                <Picker.Item
                  label="Custodial kidnapping"
                  value="Custodial kidnapping"
                />
                <Picker.Item label="Gang kidnapping" value="Gang kidnapping" />
              </Picker>
            </View>
          </View>
